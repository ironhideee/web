(function (global, factory) {
	...
	(factory((global['ngx-uploader'] = {}),global.ng.core));
...
var mergeMap$4 = mergeMap_1.mergeMap;
...
var NgUploaderService = /** @class */ (function () {
    ...
    function NgUploaderService(concurrency, contentTypes) {
        ...
        this.uploadScheduler
            .pipe(mergeMap$4(function (upload) { return _this.startUpload(upload); }, concurrency))
    ...
    NgUploaderService.prototype.handleFiles = function (incomingFiles) {
        ...
        (_d = this.queue).push.apply(_d, [].map.call(allowedIncomingFiles, function (file, i) {
...
var NgUploaderModule = /** @class */ (function () {
