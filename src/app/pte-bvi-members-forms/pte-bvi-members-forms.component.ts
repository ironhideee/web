...
@Component({
  selector: 'app-pte-bvi-members-forms',
  templateUrl: './pte-bvi-members-forms.component.html',
  styleUrls: ['./pte-bvi-members-forms.component.sass']
})
export class PteBviMembersFormsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.directorForm = this.fb.group({
      ...
      working_time: [this.director.working_time, Validators.required],
