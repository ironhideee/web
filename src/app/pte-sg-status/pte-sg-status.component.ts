...
@Component({
  selector: 'app-pte-sg-status',
  templateUrl: './pte-sg-status.component.html',
  styleUrls: ['./pte-sg-status.component.sass']
})
export class PteSgStatusComponent implements OnInit {
