...
@Component({
  selector: 'app-legal-checkout',
  templateUrl: './legal-checkout.component.html',
  styleUrls: ['./legal-checkout.component.sass']
})
export class LegalCheckoutComponent implements OnInit {
